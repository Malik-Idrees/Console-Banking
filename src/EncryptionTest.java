...
public class EncryptionTest {
	...
	/*    public static void main(String[] args) {
	    	String a = encrypt("4455");
	    	String b = decrypt("1100");
	    ...
	    public static String encrypt(String pin) {
			...
			System.out.printf(" %s pin is encrypted into :%s \n",pin,encrypted_pin);
			return  encrypted_pin;
		}
	    
	    
	    public static String decrypt(String pin) {
	      ...
	      //conversion into integers for applying arithmetic operations
			...
			System.out.printf("%s pin original is :%s\n",pin,decrypted_pin);
